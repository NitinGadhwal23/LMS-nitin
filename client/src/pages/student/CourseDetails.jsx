    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl text-gray-500 z-10">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Deepak Sir</span>{" "}
          </p>
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  ...
                  >
                    <ul className="list-disc md:pl-10 pl-4 pr-4 text-gray-600 py-2 border-t border-gray-300 ">
                        ...
                        <li className="flex items-start gap-2 py-1" key={i}>
                          ...
                          <div className="flex items-center justify-between w-full text-xs md:text-default text-gray-800">
                            ...
                            <div className="flex gap-2">
                              ...
                              <p>
                                {humanizeDuration(
                                  lecture.lectureDuration * 1000 * 60,
                                  { units: ["h", "m"] }
                                )}
                              </p>
                            </div>
          ...
          <div className="py-20 text-sm md:text-default">
            <h3 className="text-xl font-semibold text-gray-800">Couse Description</h3>
            <p
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
             ...
             <button className="bg-blue-600 text-white font-medium rounded md:mt-6 mt-4 py-3 w-full">{isAlreadyEnrolled ? 'Already Enrolled':'Enroll Now'}</button>
              <div className="pt-6">
                ...
                <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                    ...
                    <li>Certificate of completions. </li>
                </ul>
              </div>
          </div>
        </div>
